...
Form::Form(std::string newName, int newGradeSign, int newGradeExec, bool isMarked) : name(newName), marked(isMarked), gradeSign(newGradeSign), gradeExec(newGradeExec) {
...
Form::Form(const Form& other) : name(other.name), marked(other.marked), gradeSign(other.gradeSign), gradeExec(other.gradeExec) {
